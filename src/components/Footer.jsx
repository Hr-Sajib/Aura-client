...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover">Art Gallary</a>
    <a className="link link-hover">Art & Crafts Management</a>
    <a className="link link-hover">Art Marketing</a>
  ...
  <nav>
    ...
    <a className="link link-hover">Cookie policy</a>
            ...
            <aside className="items-center grid-flow-col">
                ...
                <p><b>Aura Ltd.</b> <br/>Providing awesome art since 1992</p>
            </aside> 
